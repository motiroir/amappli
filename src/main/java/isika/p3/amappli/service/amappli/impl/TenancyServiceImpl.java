...
public class TenancyServiceImpl implements TenancyService {
	...
	public void addTestTenancies() throws IOException {
		...
		// 1. Le ContentBlock pour la présentation de l'AMAP
		ContentBlock presentationBlock3 = ContentBlock.builder().isValue(false).contentTitle("value2").contentText(
				"Groots est une amap qui vous connectera avec vos producteurs locaux, pour une meilleure transparence et distribution des richesses")
				.contentImgName("value2.jpg").contentImgTypeMIME("image/jpeg")
				.contentImg(Base64.getEncoder().encodeToString("imageBytesPlaceholder".getBytes()))
		...
		// FOURTH TENANCY
		Tenancy t4 = Tenancy.builder().tenancyName("GreenHaven").tenancyAlias("greenmaven")
		...
		ContentBlock valueBlock41 = ContentBlock.builder().isValue(true).contentTitle("Respect de la Nature")
				.contentText("Nos méthodes de production respectent la biodiversité.").contentImgName("value1.jpg")
				.contentImgTypeMIME("image/png")
				.contentImg(Base64.getEncoder().encodeToString("imageBytesPlaceholder".getBytes()))
				.homePageContent(homePageContent4).build();

		ContentBlock valueBlock42 = ContentBlock.builder().isValue(true).contentTitle("Produits de Qualité")
				.contentText("Chaque produit est soigneusement sélectionné.").contentImgName("value2.jpg")
				.contentImgTypeMIME("image/png")
				.contentImg(Base64.getEncoder().encodeToString("imageBytesPlaceholder".getBytes()))
				.homePageContent(homePageContent4).build();

		ContentBlock valueBlock43 = ContentBlock.builder().isValue(true).contentTitle("Communauté Locale")
		...
		// CINQUIÈME TENANCY
		Tenancy t5 = Tenancy.builder().tenancyName("GreenFields").tenancyAlias("greenfields")
				.tenancySlogan("Des champs verts pour des générations durables").email("greenfields@gmail.com")
		...
		ContentBlock valueBlock53 = ContentBlock.builder().isValue(true).contentTitle("Qualité Supérieure")
		...
		ContentBlock valueBlock61 = ContentBlock.builder().isValue(true).contentTitle("Origine Garantie")
