    ...
    <nav class="navbar navbar-expand-md col-offset-1 col-8 align-content-center">
        ...
        <div class="collapse navbar-collapse" id="nav-content">
            <ul class="navbar-nav w-100 justify-content-md-evenly">
                <li class="nav-item"><a href="#" class="nav-link nunito text-decoration-none fc-300 fch-500" data-bs-toggle="collapse" data-bs-target=".navbar-collapse.show">La boutique</a></li>
                <li class="nav-item"><a href="amapPage" class="nav-link nunito text-decoration-none fc-300 fch-500" data-bs-toggle="collapse" data-bs-target=".navbar-collapse.show">C'est quoi une Amap ?</a></li>
                <li class="nav-item"><a href="contact" class="nav-link nunito text-decoration-none fc-300 fch-500" data-bs-toggle="collapse" data-bs-target=".navbar-collapse.show">Contact</a></li>
                <li class="nav-item"><a href="amap/amaplogin/login" class="btn rounded-pill btn-500 px-4" data-bs-toggle="collapse" data-bs-target=".navbar-collapse.show">Se connecter</a></li>
            </ul>
        </div>
    </nav>
</div>
