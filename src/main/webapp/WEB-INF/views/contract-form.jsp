...
<body>
	...
	<form:form method="POST" action="/Amappli/contracts/add"
...
<form:select path="contractWeight">
		...
		<br>
    Prix : <form:input path="contractPrice" type="number" step="0.01" />
		<br>
    ...
    Image URL : <form:input path="imageUrl" />
		...
		<a href="/Amappli/contracts/list">Voir la liste des contrats</a>
